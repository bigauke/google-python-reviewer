...
def pipeline():
    ...
    if not corpus_dir.exists() or not (list(corpus_dir.glob("*.pdf")) or list(corpus_dir.glob("*.md"))):
        pytest.skip("data/corpus/ vazio — adicione pelo menos 1 arquivo (.pdf ou .md)")
